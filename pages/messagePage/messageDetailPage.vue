<template>
	...
	<basePageComponents ref="basePage" :apiLoadingStatus="apiLoadingStatus" @reload="reload" :isLoading="!pageLoading">
		<view slot="body">
			<view class="content">
				<view class="gui-h4">{{$t('messagepage_messagedetailpage_127', [newsInfo.head])}}</view>
				<view class="message-info-time">2021-01-26 17:32:42{{newsInfo.createTime}}</view>
				<view class="line"></view>
				<text class="gui-h5">{{$t('messagepage_messagedetailpage_128', [newsInfo.info])}}</text>
			</view>
		</view>
	</basePageComponents>
