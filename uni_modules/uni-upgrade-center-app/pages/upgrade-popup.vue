...
<script>
	...
	export default {
		...
		onLoad({
			...
			const requiredKey = ['platform', 'url', 'wgt']
		...
		computed: {
			isWGT() {
				return this.wgt === 'true'
			},
			isiOS() {
				// return !this.isWGT ? this.platform == 'ios' : false;
					return true;
			}
		},
		methods: {
...
<style>
	...
	.content-button {
		...
		background: linear-gradient(to right, #ff8d1a, #ff8a14);
	}
