...
export default {
	...
	props : {
		...
		units     : { type : Array , default:function(){return new Array(this.$t('gui_datetime_bt_base_42'),this.$t('gui_datetime_bt_base_43'),this.$t('gui_datetime_bt_base_44'),this.$t('gui_datetime_bt_base_45'),this.$t('gui_datetime_bt_base_46'),this.$t('gui_datetime_bt_base_47'))}},
