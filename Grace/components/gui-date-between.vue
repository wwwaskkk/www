<template>
	<view>
		...
		:style="{backgroundColor:weekBg}">
			<text class="gui-date-bt-item gui-date-bt-week gui-block-text">{{$t('gui_date_between_23')}}</text>
			<text class="gui-date-bt-item gui-date-bt-week gui-block-text">{{$t('gui_date_between_24')}}</text>
			<text class="gui-date-bt-item gui-date-bt-week gui-block-text">{{$t('gui_date_between_25')}}</text>
			<text class="gui-date-bt-item gui-date-bt-week gui-block-text">{{$t('gui_date_between_26')}}</text>
			<text class="gui-date-bt-item gui-date-bt-week gui-block-text">{{$t('gui_date_between_27')}}</text>
			<text class="gui-date-bt-item gui-date-bt-week gui-block-text">{{$t('gui_date_between_28')}}</text>
			<text class="gui-date-bt-item gui-date-bt-week gui-block-text">{{$t('gui_date_between_29')}}</text>
		</view>
...
export default{
	...
	props : {
		...
		unit        : { type : Array,  default:function(){return [this.$t('gui_date_between_30'),this.$t('gui_date_between_31')];}},
	...
	methods:{
		...
		currentMonth : function () {
			...
			m = m < 10 ? ('0' + m) : m;
			return y + this.$t('gui_date_between_30') + m + this.$t('gui_date_between_31');
		},
