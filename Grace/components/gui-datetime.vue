...
export default {
	name  : "gui-datetime",
	props : {
		cancelText    : { type : String,  default : this.$t('gui_datetime_48') },
		cancelTColor  : { type : String,  default : '#888888' },
		confirmText   : { type : String,  default : this.$t('gui_datetime_49') },
		...
		units         : { type : Array ,  default : function(){return new Array(this.$t('gui_datetime_50'),this.$t('gui_datetime_51'),this.$t('gui_datetime_52'),this.$t('gui_datetime_53'),this.$t('gui_datetime_54'),this.$t('gui_datetime_55'))}},
