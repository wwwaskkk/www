...
export default{
	...
	props : {
		...
		refreshText        : {type:Array,   default:function () {
		  return [this.$t('gui_refresh_94'),this.$t('gui_refresh_95'),this.$t('gui_refresh_96'),this.$t('gui_refresh_97')];
		}},
		refreshBgColor     : {type:Array,   default:function () {
			return ['#FFFFFF','#FFFFFF','#FFFFFF','#FFFFFF'];
		}},
		refreshColor       : {type:Array,   default:function () {
			return ['#B31A51','#B31A51','#A31C58','#A31C58'];
		}},
		...
		loadMoreText       : {type:Array, default:function () {
			return ['',this.$t('gui_page_88'), this.$t('gui_page_89')];
		}},
